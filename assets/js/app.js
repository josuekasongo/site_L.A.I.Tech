...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function openModal(card) {
        // R�cup�rer les informations de la carte cliqu�e
        ...
        document.body.style.overflow = 'hidden'; // Emp�cher le d�filement de la page en arri�re-plan
    }
    ...
    // Ajouter l'�v�nement de clic sur toutes les cartes d'expertise
    ...
    // Fermer le modal en cliquant � l'ext�rieur du contenu
